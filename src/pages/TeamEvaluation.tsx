...
const TeamEvaluation: React.FC = () => {
  ...
  const { control, handleSubmit, reset } = useForm<EvaluationFormData>({
    defaultValues,
    ...
    <Box
      sx={{
        ...
        "&::before": {
          ...
          bottom: 0,
          background:
            "radial-gradient(circle at 20% 80%, rgba(120, 58, 237, 0.05) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(37, 99, 235, 0.05) 0%, transparent 50%)",
          pointerEvents: "none",
        },
      }}
    >
        ...
        <Slide direction="up" in timeout={800}>
          <Paper
            sx={{
              ...
              border: `2px solid ${
                searchFocused ? theme.palette.primary.main : "transparent"
              }`,
                    ...
                    <CardContent sx={{ p: 4 }}>
                      ...
                      >
                        ...
                        <Typography
                          ...
                          gutterBottom
                        >
                          {teamData.lead.institution} • {teamData.lead.city},{" "}
                          {teamData.lead.state}
                        </Typography>
                        <Controller
                          name="leadPresent"
                        ...
                        <Grid item xs={12} md={6}>
                          ...
                          >
                            {[
                              {
                                key: "usesGemini",
                                label: "Using Gemini/Jules/Stitch/Antigravity?",
                              },
                              { key: "usesAI", label: "Using other AI Tools?" },
                              {
                                key: "isAgent",
                                label: "Is Agent-based solution?",
                              },
                              {
                                key: "predeveloped",
                                label: "Looks pre-developed?",
                              },
                              {
                                key: "changedIdea",
                                label: "Changed idea during event?",
                              },
                            ].map((item) => (
                              <Controller
                                key={item.key}
                      ...
                      >
                        <Box>
                          ...
                          <Typography variant="body2" color="text.secondary">
                            Total Score: {totalPoints}/{maxPoints} points (
                            {Math.round(completionPercentage)}%)
                          </Typography>
                        </Box>
